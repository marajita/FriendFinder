...
module.exports = function(app) {
  ...
  app.post("/api/friends", function(req, res) {
    friendMatched = null; // initializing friendMatched as null to begin
    ...
    var minScoreDifference = 99999999; //this will keep updating because of line 44
    var friendSoFar = null;
    friends.forEach(friend => {
      // this will be the first array from friends where friend is iterator for the whole friends array object
